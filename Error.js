...
spotter.error = (function(){
	...
	__public.targetCont.addEventListener('click',function(){ spotter.toggleClass.add(spotter.error.errorShade,"hide");spotter.toggleClass.add(this,"hide"); },false);
	
	__public.errorShade = document.createElement("DIV");
	__public.errorShade.id = "error-shade";
	__public.errorShade.className = "hide";
	__public.errorShade.addEventListener('click',function(){ spotter.toggleClass.add(spotter.error.targetCont,"hide");spotter.toggleClass.add(this,"hide"); },false);
	...
	__private.errorBox = function(str){
		...
		spotter.toggleClass(__public.targetCont,"hide");
		spotter.toggleClass(__public.errorShade,"hide");
	};
...
spotter.testLoaded(function(){
	document.body.appendChild(spotter.error.targetCont);
	document.body.appendChild(spotter.error.errorShade);
});
